...
class Agents():   
    ...
    def step(self, states, actions, rewards, next_states, dones):
        ...
        for i in range(self.num_agents): 
            self.memory.add(states[i,:], actions[i,:], rewards[i], next_states[i,:], dones[i]) # Save experience in memory
    ...
    def soft_update(self, local_model, target_model, tau):
        ...
        Params
        ======
            local_model: PyTorch model (weights copied from)
...
class ReplayBuffer:
    ...
    def __init__(self, action_size, buffer_size, batch_size, seed):
        ...
        self.action_size = action_size
        # internal memory (deque) with buffer size - number of experiences 
